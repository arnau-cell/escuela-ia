...
Este sitio es estático (no tiene servidor de aplicación propio ni base de datos), no requiere registro
para consultarlo, y **hoy no incluye ningún formulario ni captura de datos personales**. El tratamiento
de datos es, por diseño, mínimo.
