...
This site is static (no application server or database of its own), requires no sign-up to browse, and
**today includes no form or personal-data capture at all**. Data processing is minimal by design.
